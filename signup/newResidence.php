...
$stmt_user->bind_param('sssssssssss',$number,$add_first_name,$add_middle_name,$add_last_name,$add_username,$add_password,$user_type,$add_contact_number,$add_email_address,$new_image_name,$new_image_path);
$stmt_user->execute();
$stmt_user->close();
