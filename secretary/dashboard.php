...
<body class="hold-transition sidebar-mini sidebar-collapse   layout-footer-fixed">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-light">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <h5><a class="nav-link" style="color: #b30000; font-weight: 600;" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a></h5>
        </li>
        <li class="nav-item d-none d-sm-inline-block" style="font-variant: small-caps;">
          <h5 class="nav-link" style="color: #b30000; font-weight: 600;"><?= $barangay ?></h5>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <h5 class="nav-link" style="color: #b30000; font-weight: 600;">-</h5>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <h5 class="nav-link" style="color: #b30000; font-weight: 600;"><?= $zone ?></h5>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <h5 class="nav-link" style="color: #b30000; font-weight: 600;">-</h5>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <h5 class="nav-link" style="color: #b30000; font-weight: 600;"><?= $district ?></h5>
        </li>
      </ul>
              ...
              <div class="row">
                ...
                <div class="col-sm-12">
                  ...
                  <div class="small-box bg-success">
                    <div class="inner">
                      <h3><?= number_format($count_voters_yes) ?><stlye style="font-size: 20px"></stlye>
                      </h3>
