...
<link rel="stylesheet" href="assets/plugins/fontawesome-free/css/all.min.css">
  ...
  <style>
    ...
    .double {
  background-color:  rgba(179,0,0,.75);
...
<div class="row mb-3">
  <div class="col-sm-4">
    <div class="card  h-100">
      <div class="card-body " style="border: 10px solid rgba(179,0,0,.75); border-radius: 0;">
  ...
  <div class="col-sm-8">
    <div class="card  card-tabs h-100" style="border: 10px solid rgba(179,0,0,.75); border-radius: 0;">
