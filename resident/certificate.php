...
<div class="wrapper  p-0 maring-0 bg-transparent" >
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand-md " style="background-color: #ff0000">
    <div class="container">
  ...
  <div class="content-wrapper"  style="background-color: transparent">
    ...
    <div class="container-fluid " >
                  ...
                  <div class="card mt-5" style="border: 10px solid rgba(255,0,0,0.75); border-radius: 0;">
  ...
  <footer class="main-footer text-white" style="background-color: #ff0000">
