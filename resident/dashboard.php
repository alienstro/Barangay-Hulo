...
<head>
  ...
  <style>
    ...
    .custom-navbar {
      ...
      padding: 4px 15px; /* 👈 binawasan para mas maikli ang height */
    }
    ...
    a.red:hover, a.green:hover, a.yellow:hover {
      color: #b30000;
    ...
    .green span, .red span, .yellow span {
...
<div class="wrapper">
  ...
  <img src="../assets/logo/LogoHulo.PNG"  
       alt="Barangay Logo" 
       class="img-circle" 
  ...
  <span class="brand-text text-white" style="font-weight:700; font-size:20px;">
    Barangay Hulo
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        <li class="nav-item">
          <a href="#" class="nav-link text-white rightBar">
            <i class="fas fa-home"></i> DASHBOARD
          </a>
        </li>
        <li class="nav-item">
          <a href="profile.php" class="nav-link text-white rightBar" style="text-transform:uppercase;">
            <i class="fas fa-user-alt"></i> <?= $last_name_user ?>-<?= $user_id ?>
          </a>
        </li>
        <li class="nav-item">
          <a href="../logout.php" class="nav-link text-white rightBar" style="text-transform:uppercase;">
  ...
  <div class="content-wrapper">
    <div class="content">
      <div class="container-fluid pt-5">
        <div class="card" style="background-color: rgba(179,0,0,.75);">
          <div class="card-body text-center text-white">
            <img src="../assets/logo/LogoHulo.JPG" alt="logo" class="img-circle" style="height:300px; width:300px;">
            <h1 class="card-text">
              WELCOME, <span style="font-weight: 1000; text-transform: uppercase;"><?= $first_name_user ?></span>
            </h1>
