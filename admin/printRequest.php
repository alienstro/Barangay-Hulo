...
#qwe{
  background-image: url('../assets/logo/seal.JPG');
...
<div class="d-flex justify-content-around">
  ...
  <div >
  <img src="../assets/logo/mandaLogo.jpg" class="img-circle" id="mandaLogo" alt="logo">
  </div>
</div>
...
<hr style="height: 10px; background-color: skyblue;">
  ...
  <div class="container text-lg transparentbox " id="qwe">
    ...
    <p class="pl-5 ml-5" style="font-size:20pt; padding: 0; margin: 0;">Done in the City of Mandaluyong this <b><u> <?= '_'.$today .'_' ?> </u> day of <?= $month ?>, <u><?= $year?></u>.<b>  </p>
    <br>
