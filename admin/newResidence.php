...
<head>
  ...
  <title>Barangay Hulo - New Residence</title>
          ...
          submitHandler: function(form) {
            $.ajax({
              ...
              success: function(resp) {
                ...
                var html = '<p>Resident created successfully.</p>' +
                  '<p><strong>Username:</strong> ' + username + '</p>' +
                  '<p><strong>Password:</strong> ' + password + '</p>' +
                  '<p><small>Please note the password is shown only once. Ask resident to change it on first login.</small></p>';

                Swal.fire({
                  title: '<strong class="text-success">Resident Created</strong>',
                  icon: 'success',
                  html: html,
                  width: '520px',
                  confirmButtonColor: '#b30000',
